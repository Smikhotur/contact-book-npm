...
import addContactImg from '../../../../assets/images/addContact.png';
...
export const FormEdit = ({config}) => {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(actions.putUser(infoPerson, JSON.parse(localStorage.getItem('person'))[0].id));
    setInfoPerson(() => ({
      photo: '',
      first_name: '',
      last_name: '',
      ...
      <form onSubmit={handleSubmit} action="">
        <div className="contact-details__form-edit">
          ...
          >
            ...
            <input
              style={infoPerson.first_name ? {color: '#7A7B85'} : {color: 'transparent'}}
          ...
          >
            <span>Last name</span>
            <input
              style={infoPerson.last_name ? {color: '#7A7B85'} : {color: 'transparent'}}
              onChange={handleChange}
              onFocus={(e) => {
                setVisible(true);
                setIdInput(e.target.id);
          ...
          >
            ...
            <span>Job title</span>
            <input
              style={infoPerson.jobTitle ? {color: '#7A7B85'} : {color: 'transparent'}}
              onChange={handleChange}
              onFocus={(e) => {
                setVisible(true);
                setIdInput(e.target.id);
          ...
          >
            ...
            <span>Email</span>
            <input
              style={infoPerson.email ? {color: '#7A7B85'} : {color: 'transparent'}}
              onChange={handleChange}
              onFocus={(e) => {
                setVisible(true);
                setIdInput(e.target.id);
          ...
          >
            ...
            <span>Birthday</span>
            <input
              style={infoPerson.birthday ? {color: '#7A7B85'} : {color: 'transparent'}}
              onChange={handleChange}
              onFocus={(e) => {
                setVisible(true);
                setIdInput(e.target.id);
