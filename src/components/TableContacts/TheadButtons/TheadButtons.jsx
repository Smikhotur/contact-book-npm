...
import arrows from '../../../assets/images/Sort.svg'
  ...
  return (
    <>
      <tr style={{cursor: 'default'}} className="contact-book__head-table">
        ...
        >
          <div
            className={`contact-book__thead-btn-block-${config?.style}`}
          >
            <div
              title="Cancel all"
            ...
            <div
              ...
              style={{padding: '5px'}}
            >
              <div className={`contact-book__checkbox-arrow-${config?.style}`}></div>
            </div>
        ...
        >
          Email
          <img
            className="contact-book__arrow-img"
            src={arrows}
            alt="sort"
          />
        </th>
