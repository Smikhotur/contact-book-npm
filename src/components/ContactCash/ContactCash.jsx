...
import step1 from '../../assets/images/stepOne.png';
import step2 from '../../assets/images/stepTwo.png';
import step3 from '../../assets/images/stepThree.png';
...
import tip7 from '../../assets/images/tip7.svg';
import tip8 from '../../assets/images/tip8.svg';
    ...
    <section className="contact-book__main-content">
      ...
      <section className="contact-book__contact-cash contact-cash">
        ...
        <h3 className="contact-cash__title-steps">
          Follow these{' '}
          <span
            className={`contact-cash__title-steps-color-${config?.style}`}
          >
            Steps:
          </span>
        </h3>
        ...
        <div className="contact-cash__steps-inner">
          <div className="contact-cash__step-box">
            <div className="contact-cash__step-header">
              <h4 className={`contact-cash__step-title-${config?.style}`}>Step 1.</h4>
          ...
          <div className="contact-cash__step-box">
            <div className="contact-cash__step-header">
              <h4 className={`contact-cash__step-title-${config?.style}`}>Step 2.</h4>
              <div className={`contact-cash__inner-step-img-${config?.style}`}>
                <img
                  src={step2}
                  alt="icon"
          ...
          <div className="contact-cash__step-box">
            <div className="contact-cash__step-header">
              <h4 className={`contact-cash__step-title-${config?.style}`}>Step 3.</h4>
              <div className={`contact-cash__inner-step-img-${config?.style}`}>
                <img
                  src={step3}
                  alt="icon"
        ...
        <h3 className="contact-cash__title-steps">
          ...
          <span className={`contact-cash__title-steps-color-${config?.style}`}>Steps:</span>
        </h3>
          ...
          <div className="contact-cash__tip-inner">
            <div className="contact-cash__tip-box">
              <h4 className="contact-cash__tip-title">
                <span className={`contact-cash__tip-title-color-${config?.style}`}>Tip 1</span>
                {` Profiles & Social Media Presence`}
                <p className="contact-cash__tip-text">
                  Create social media profiles and multiple Sumra tags
                  profiles; and then promote your unique Referral codes and
                  links.
                </p>
              </h4>
              <img
          ...
          <div className="contact-cash__tip-inner-white">
            <div className="contact-cash__tip-box-white">
              ...
              <h4 className="contact-cash__tip-title-white">
                <span className={`contact-cash__tip-title-color-${config?.style}`}>
                  Tip 2
                </span>
                {` Share Your Referral Cash Bonus`}
                <div className="contact-cash__tip-text-white">
                  <p>
                    For every 1000 Referrals that you generate, we
                    automatically{' '}
        ...
        <div className="contact-cash__tip-block">
          ...
          <div className="contact-cash__tip-inner">
            <div className="contact-cash__tip-box">
              <h4 className="contact-cash__tip-title">
                <span className={`contact-cash__tip-title-color-${config?.style}`}>Tip 3</span>
                ...
                <div className="contact-cash__tip-text">
                  ...
                  <p>
                    Share your code, link, knowledge and substantially
                    increase your income as
                    <br />
                    you do so.
                  </p>
                </div>
            ...
            <div className="contact-cash__tip-box-white">
              ...
              <h4 className="contact-cash__tip-title-white">
                ...
                <div className="contact-cash__tip-text-white">
                  ...
                  <p>
                    Set up a blog or website or an online medium or partner
                    with a website, and then obtain our
                    <br />
                    Affiliate API by contacting us. We can assist you to
                    quickly and easily install our Affiliate API.
                  </p>
                </div>
              </h4>
            </div>
        ...
        <div className="contact-cash__tip-block">
          ...
          <div className="contact-cash__tip-inner">
            <div className="contact-cash__tip-box">
              <h4 className="contact-cash__tip-title">
                <span className={`contact-cash__tip-title-color-${config?.style}`}>Tip 5</span>
                {` Review & Refer US`}
                <div className="contact-cash__tip-text">
                  <p>
        ...
        <div className="contact-cash__tip-block">
          ...
          <div className="contact-cash__tip-inner">
            <div className="contact-cash__tip-box">
              <h4 className="contact-cash__tip-title">
                <span className={`contact-cash__tip-title-color-${config?.style}`}>Tip 7</span>
                {` Google My Business `}
                <p className="contact-cash__tip-text">
            ...
            <div className="contact-cash__tip-box-white">
              ...
              <h4 className="contact-cash__tip-title-white">
                ...
                <p className="contact-cash__tip-text-white">
                  Create, post and send messages of testimonials from
                  Earnings. Doing so allows people to see
                  <br />
